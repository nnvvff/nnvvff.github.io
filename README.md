...
does not change when a visitor simply refreshes the page. It includes seconds to
show multiple updates on the same day. Open-source icon licenses are in `site-static/icons/`.
